...
JModelLegacy::addIncludePath(JPATH_SITE . '/components/com_panorama/models');

$mainframe = JFactory::getApplication()->input;
$controller = $mainframe->get("controller");
include (JPATH_SITE . '/components/com_panorama/controllers/'.$controller.'.php');
